...
export async function POST(req: NextRequest) {
  ...
  const { url, name, threshold, selector, mobile, minImportance, cookies, headers, webhookUrl, category } = body;
  ...
  try {
    await addWatchedUrl(user.id as string, url, name, { threshold, selector, mobile, minImportance, cookies, headers, webhookUrl, category });
